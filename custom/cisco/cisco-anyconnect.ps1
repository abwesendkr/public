...
$MSIFile = Join-Path -path $PSScriptRoot -ChildPath "anyconnect-win-4.10.08029-core-vpn-predeploy-k9.msi"
...
try {
    ...
    Copy-item -Path "$psscriptroot\preferences_global.xml" -Destination "$env:Programdata\Cisco\Cisco AnyConnect Secure Mobility Client"
    # Erfolgreiches Ende
